...
static struct hash_entry * make_entry(const char *key, const struct work_record value)
{
...
static int try_set(Hash *self, const char *key, const struct work_record value)
{
